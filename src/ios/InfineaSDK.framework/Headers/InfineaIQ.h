...
/**
 The developer is needed in order to use the framework. Please contact IPC for a developer key. This key need to be set before calling any other methods, preferrably in application:didFinishLaunchingWithOptions: 
