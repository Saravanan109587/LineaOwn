 ...
 */
- (instancetype)initWithDeviceName:(NSString *)deviceName model:(NSString *)deviceModel serial:(NSString *)deviceSerial battery:(int (^)())level;
 ...
 */
- (void)setDeviceValueWithBlock:(NSString *(^)())block forField:(NSString *)field title:(NSString *)prettyName;
